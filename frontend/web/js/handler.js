...
$('input#signupform-avatar').change(function(event) {
        
        var $that = $('#form-signup'),
        ...
        $('.selected_avatar img')
            .attr('src', '/avatars/165x165/site/'+id_avatar_src+getRandom);


        //переменная id_avatar_val - прописана в view site/signup
        $('#signupform-user_avatar').val(id_avatar_val);
          ...
          success: function(data){
            ...
            if(data){
                ...
                if(data.success) {
                    ...
                    $('.selected_avatar img')
                                    .attr('src', data.namefile+getRandom);
                } else {
                    alert(data.error);
                }
