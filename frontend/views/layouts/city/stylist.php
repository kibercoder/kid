...
<html lang="en">
	...
	<body id="stylist">
		...
		<section id="wrapper">
			...
			<source src="<?=$CityAsset->baseUrl ?>/media/stylist.mp4" />
			<source src="<?=$CityAsset->baseUrl ?>/media/stylist.webm" type='video/webm; codecs="vp8, vorbis"' />
			<source src="<?=$CityAsset->baseUrl ?>/media/stylist.ogv" type='video/ogg; codecs="theora, vorbis"' />
			</video>

			<section id="wrap_site">
				<div id="header" style="background: url('<?=$CityAsset->baseUrl ?>/img/ribbon2.png') no-repeat scroll -9px 125px transparent;">
					<a href="#" id="logo">
					...
					<div id="left_block">
						<div id="board">
							<ul>
								...
								<?php if($stylist){ ?>
								<ol>
									<a href="<?= Url::to(['city/settle','name' => 'stylist']);?>">Устроиться</a>
								</ol>
								<?php } ?>
							</ul>
						</div>
